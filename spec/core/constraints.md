...
5. **No TODOs in shipped code** — users and consumers receive output
   as-is.
6. **No unresolved blocking ambiguity** — ask before implementing
   when missing requirements could change outcomes.
7. **Assumptions must be explicit** — record assumptions with
   confidence and verification path.
8. [Add your project-specific non-negotiables here]
